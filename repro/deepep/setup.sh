...
#
# What this fixes for the current cluster's container:
...
#   3. NVSHMEM bootstrap MPI plugin lives in /usr/lib/.../nvshmem/13, not /opt/nvshmem/lib
#      → prepend the right path to LD_LIBRARY_PATH
